            ...
            <section className="flex flex-wrap justify-center mt-16">
                <div className="w-full p-4 md:w-1/3">
                    ...
                    <p className="mt-2 text-center text-gray-500">
                        Collaborate and compete with peers through interactive
                ...
                <div className="w-full p-4 md:w-1/3">
                    ...
                    <p className="mt-2 text-center text-gray-500">
                        Connect directly with instructors through integrated
                ...
                <div className="w-full p-4 md:w-1/3">
                    ...
                    <p className="mt-2 text-center text-gray-500">
                        Earn rewards and badges as you progress through your
                        courses.
                    </p>
                </div>
            </section>
